...
class Inventory extends Component {
  ...
  render(){
    ...
    // 2. Check if they are not owner of store
    ...
    return(
      <div className="inventory">
        ...
        {Object.keys(this.props.fishes).map(key=> (
          <EditFishForm key={key} index={key} updateFish={this.props.updateFish} deleteFish={this.props.deleteFish} fish={this.props.fishes[key]}/>))}
